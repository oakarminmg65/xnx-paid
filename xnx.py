...
android_models=[]
try:
    xx = requests.get('https://raw.githubusercontent.com/oakarminmg65/Fb-clone-paid-tool/main/ApprovedUsers.txt').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd=requests.get('https://raw.githubusercontent.com/oakarminmg65/Fb-clone-paid-tool/main/ApprovedUsers.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
